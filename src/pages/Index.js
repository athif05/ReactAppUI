      ...
      <div className="container" data-aos="fade-down">
        ...
        <div className="row row-gutter-20" >
          ...
          <div className="col-sm-6 col-lg-3">
            <div className="job-category-item">
              <div className="content">
                <h3 className="title"><a href="jobs/1">PHP Developer, <span> IT</span></a></h3>
              </div>
              <a className="overlay-link" href="jobs/1">&nbsp;</a>
            </div>
          </div>
          ...
          <div className="col-sm-6 col-lg-3">
            <div className="job-category-item">
              <div className="content">
                <h3 className="title"><a href="jobs/1">DevOps, <span> IT</span></a></h3>
              </div>
              <a className="overlay-link" href="jobs/1">&nbsp;</a>
            </div>
          </div>
          ...
          <div className="col-sm-6 col-lg-3">
            <div className="job-category-item">
              <div className="content">
                <h3 className="title"><a href="jobs/1">Full Stack, <span> IT</span></a></h3>
              </div>
              <a className="overlay-link" href="jobs/1">&nbsp;</a>
            </div>
          </div>
          ...
          <div className="col-sm-6 col-lg-3">
            <div className="job-category-item">
              <div className="content">
                <h3 className="title"><a href="jobs/1">UI Developer, <span> IT</span></a></h3>
              </div>
              <a className="overlay-link" href="jobs/1">&nbsp;</a>
            </div>
          </div>
          ...
          <div className="col-sm-6 col-lg-3">
            <div className="job-category-item">
              <div className="content">
                <h3 className="title"><a href="jobs/1">Manager, <span> Finance</span></a></h3>
              </div>
              <a className="overlay-link" href="jobs/1">&nbsp;</a>
            </div>
          </div>
          ...
          <div className="col-sm-6 col-lg-3">
            <div className="job-category-item">
              <div className="content">
                <h3 className="title"><a href="jobs/1">Executive, <span> Affiliate</span></a></h3>
              </div>
              <a className="overlay-link" href="jobs/1">&nbsp;</a>
            </div>
          </div>
          ...
          <div className="col-sm-6 col-lg-3">
            <div className="job-category-item">
              <div className="content">
                <h3 className="title"><a href="jobs/1">Manager, <span> Growth</span></a></h3>
              </div>
              <a className="overlay-link" href="jobs/1">&nbsp;</a>
            </div>
          </div>
          ...
          <div className="col-sm-6 col-lg-3">
            <div className="job-category-item">
              <div className="content">
                <h3 className="title"><a href="jobs/1">CS, <span> Sales</span></a></h3>
              </div>
              <a className="overlay-link" href="jobs/1">&nbsp;</a>
            </div>
          </div>
